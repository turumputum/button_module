...
#define GESTURE_SENSITIVITY_1   50//50
#define GESTURE_SENSITIVITY_2   20//20
...
/* Misc parameters */
#define FIFO_PAUSE_TIME         30//20      // Wait period (ms) between FIFO reads
...
#define DEFAULT_GPENTH          40//40      // Threshold for entering gesture mode
#define DEFAULT_GEXTH           30//30      // Threshold for exiting gesture mode
#define DEFAULT_GCONF1          0x40//0x40    // 4 gesture events for int., 1 for exit
#define DEFAULT_GGAIN           GGAIN_1X//GGAIN_4X
#define DEFAULT_GLDRIVE         LED_DRIVE_25MA//LED_DRIVE_100MA
