...
uint32_t W25qxx_ReadID(void) {
	...
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_RESET);HAL_GPIO_WritePin(W_CS_GPIO_Port, W_CS_Pin, GPIO_PIN_SET);
	W25qxx_Spi(0x9F);
	Temp0 = W25qxx_Spi(W25QXX_DUMMY_BYTE);
	Temp1 = W25qxx_Spi(W25QXX_DUMMY_BYTE);
	Temp2 = W25qxx_Spi(W25QXX_DUMMY_BYTE);
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_SET);HAL_GPIO_WritePin(W_CS_GPIO_Port, W_CS_Pin, GPIO_PIN_RESET);
